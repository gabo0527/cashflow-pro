...
// ============ METRIC CARD — Premium Institutional ============
          ...
          {filteredInvoices.length > 0 ? groupedInvoices.map(group => (
            <div key={group.key} className={`${THEME.card} border rounded-xl overflow-hidden`}>
              ...
              {!collapsedGroups.has(group.key) && (<>
                <div className={`grid grid-cols-[1fr_140px_100px_120px_100px_100px_140px] gap-2 px-5 py-2.5 border-b ${THEME.border} bg-slate-800/30`}>
                ...
                {group.invoices.map(inv => {
                  ...
                  return (
                    <div key={inv.id} className={`border-b ${THEME.border} border-opacity-40 last:border-0`}>
                      <div className={`grid grid-cols-[1fr_140px_100px_120px_100px_100px_140px] gap-2 px-5 py-3 items-center ${THEME.cardHover} transition-colors`}>
      ...
      {activeTab === 'expenses' && (
        <div className="space-y-4">
          ...
          <div className={`${THEME.card} border rounded-xl overflow-hidden`}>
            <div className={`grid grid-cols-[1fr_130px_100px_80px_100px_80px_140px] gap-2 px-5 py-2.5 border-b ${THEME.border} bg-slate-800/30`}>
            ...
            {filteredExpenses.length > 0 ? filteredExpenses.map(exp => {
              ...
              return (
                <div key={exp.id} className={`grid grid-cols-[1fr_130px_100px_80px_100px_80px_140px] gap-2 px-5 py-3 items-center border-b ${THEME.border} border-opacity-40 last:border-0 ${THEME.cardHover} transition-colors`}>
                  <div className="min-w-0">
